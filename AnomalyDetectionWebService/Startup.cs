...
namespace AnomalyDetectionWebService
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "AnomalyDetectionWebService", Version = "v1" });
            });
        }
        ...
        {
            // you can set the project as "Production" in Properties\launchSettings.json configuration file
